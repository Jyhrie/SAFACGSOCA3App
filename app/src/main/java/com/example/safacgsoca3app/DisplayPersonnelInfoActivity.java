...
public class DisplayPersonnelInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c1 = db.rawQuery("SELECT a_name, pa.pa_id, pa.pa_issue_qty, td.td_issued, td.td_returned, td.td_expended, td.td_spoiled FROM ammunition a, personnel_ammunition pa left join transaction_data td on td.pa_id = pa.pa_id and td_exported = 0 where a.a_id = pa.a_id and pa.op_id ="+op_id, null);
